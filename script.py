...
if __name__ == '__main__':
    ...
    for i in range(lgbm_reg_net.get_num_layers()):
        ...
        # with open(model_path, mode="wb") as f:
        #     pickle.dump(list(lgbm_reg_net.layers[0].items())[0][1][0], f)
        # print(list(lgbm_reg_net.layers[0].items()))
        # print("-----------",list(lgbm_reg_net.layers[0].items())[0][1][0])

        # print(pickle.dumps(lgbm_reg_net))
        # with open(model_path, mode="wb") as f:
        #     pickle.dump(lgbm_reg_net, f)
